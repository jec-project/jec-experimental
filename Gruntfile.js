...
/*
 * Provides tasks for building and testing the jec-experimental project.
 */
module.exports = function(grunt) {
  ...
  /*!
   * JEC Experiments Tasks:
   */

  //--> Task: builds the "jec-experimental" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-experimental" API documentation:
